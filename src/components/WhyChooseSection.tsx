...
const WhyChooseSection = () => {
  ...
  return <section id="why-choose" className="py-20 bg-cream/30">
      <div className="container mx-auto px-4">
        {/* Section Header */}
        <div className="text-center mb-16 border-0">
          <span className="text-primary font-medium tracking-wider uppercase text-sm">
            The Double Hathi Difference
          </span>
          <h2 className="font-display text-3xl md:text-4xl lg:text-5xl font-bold mt-3 mb-4 text-accent-foreground">
