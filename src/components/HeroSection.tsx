        ...
        {slides.map((_, i) => (
          <button
            ...
            className={`h-1.5 rounded-full transition-all duration-500 ${
              i === current
                ? "w-10 bg-mustard shadow-[0_0_10px_hsl(var(--mustard)/0.5)]"
      ...
      <div className="relative z-10 container mx-auto px-4 pt-20 text-center">
        <div className="max-w-4xl mx-auto">
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-cream/10 backdrop-blur-md border border-cream/20 rounded-full px-5 py-2.5 mb-8 mt-4"
          >
          ...
          >
            {[
              ...
              >
                ...
                <p className="text-cream/75 text-sm md:text-base mt-2 font-medium">{stat.label}</p>
              </motion.div>
            ))}
          </motion.div>
        </div>
