...
const BenefitsSection = () => {
  return <section id="benefits" className="py-20 md:py-32 bg-secondary text-secondary-foreground relative overflow-hidden">
      {/* Decorative Elements */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-16">
          <span className="text-mustard-light font-medium uppercase tracking-widest text-xl">
            Health Benefits
          </span>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {benefits.map((benefit, index) => <div key={index} className="group bg-secondary-foreground/5 backdrop-blur-sm rounded-2xl p-6 border border-secondary-foreground/10 hover:border-mustard/50 transition-all duration-300 animate-fade-up hover:bg-secondary-foreground/10" style={{
          animationDelay: `${index * 0.1}s`
        }}>
              <div className="w-14 h-14 rounded-xl bg-mustard/20 mb-4 group-hover:bg-mustard/30 transition-colors items-center justify-center flex flex-col">
